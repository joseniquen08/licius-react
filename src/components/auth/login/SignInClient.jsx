...
export const SignInClient = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="px-4">
      ...
      <p className="py-2 text-center text-[0.95rem]">¿Eres una empresa? Inicia sesión <Link to="/signin/restaurante" onClick={() => handleError()} className="font-bold text-brand-green-500">aquí</Link></p>
      <motion.div
