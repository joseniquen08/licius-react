        ...
        <div>
          ...
          <div className="relative mt-1 rounded-md shadow-sm">
            <input
              ...
              className="block w-full py-2 pl-10 pr-3 text-sm text-gray-600 border peer rounded-md md:font-medium focus:ring-2 invalid:border-red-600 invalid:text-red-600 invalid:focus:ring-red-100 focus:ring-brand-green-500/50 focus:border-transparent focus:outline-none border-slate-300"
            />
            <div className="absolute inset-y-0 left-0 flex text-gray-500 items-center pl-3 pointer-events-none peer-focus:text-brand-green-500">
