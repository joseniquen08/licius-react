  ...
  return (
    <section class="w-full bg-brand-gray pt-7 pb-7 md:pt-20 md:pb-24">
      ...
      <div class="box-border flex flex-col items-center content-center px-4 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
        ...
        <div class="box-border relative w-full max-w-md mt-8 mb-6 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
          <motion.img animate={{ y: [-5, 5, -5, 10, -5] }} transition={{ repeat: Infinity, duration: 6 }} src="images/capture-dashboard.png" alt="capture-dashboard" class="shadow-xl rounded-xl" />
        </div>
      </div>
    </section>
  );
