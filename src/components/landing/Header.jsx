...
export const Header = () => {
  return (
    <div className="container max-w-lg px-4 mx-auto text-left pt-16 pb-24 md:py-28 md:max-w-none md:text-center">
      ...
      <div className="mx-auto mt-7 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Descubre platos y restaurantes, conecta con usuarios con gustos similares, compra, puntúa y recomienda.</div>
