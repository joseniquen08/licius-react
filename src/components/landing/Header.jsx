...
export const Header = () => {
  return (
    <div className="px-4 pt-16 pb-24 mx-auto text-left xs:px-6 sm:px-14 md:px-20 lg:px-16 md:py-28 md:text-center">
      ...
      <div className="mx-auto text-gray-500 mt-7 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Descubre platos y restaurantes, conecta con usuarios con gustos similares, compra, puntúa y recomienda.</div>
