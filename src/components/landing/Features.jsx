...
export const Features = () => {
  return (
    <section className="py-2 bg-brand-gray">
      <div className="items-center max-w-6xl px-4 mx-auto xs:px-6 sm:px-14 md:px-20 lg:px-16">
            ...
            <div className="w-full lg:max-w-md">
              ...
              <ul>
                <li className="flex items-center py-2 space-x-4 xl:py-3">
                  ...
                  <span className="tracking-tight text-gray-500">Conecta con usuarios</span>
                </li>
                <li className="flex items-center py-2 space-x-4 xl:py-3">
                  <FaStar size={24} className="mx-1 text-yellow-500"/>
                  <span className="tracking-tight text-gray-500">Recomienda tu comida favorita</span>
                </li>
                <li className="flex items-center py-2 space-x-4 xl:py-3">
                  <FaCommentsDollar size={24} className="mx-1 text-green-500"/>
                  <span className="tracking-tight text-gray-500">Interactúa con tus restaurantes favoritos</span>
                </li>
              </ul>
            </div>
          </div>
